...
**Status: ✅ aligned (Figma-confirmado, US-020; re-verificado 2026-08-12,
US-026 3ª passada de ponto-fixo)** — protocolo completo da Regra 11
aplicado. 3ª passada: `get_design_context` fresco no nó `1431:20043` +
screenshot real confirmam os 4 ícones (adicionar/expandir/redefinir/
excluir), ordem e cor uniforme `#6b6b68` (sem destaque vermelho no botão
de excluir) — sem divergência nova.

...
pré-selecionado por padrão. Usado dentro do fluxo de criar/editar etiqueta,
não como seletor de cor genérico do sistema.
...
fresco no nó `1444:21979` + screenshot real confirmam ordem/cores dos 6
swatches (verde/teal/teal-escuro/rosa/vermelho/âmbar) e anel de seleção —
sem divergência nova.
...
[`stories/tokens/Colors.mdx`](../tokens/Colors.mdx).
...
[`organism/drop-new-tag`](../organisms/DropNewTag.mdx) (US-005) reimplementava

...
Linha de etiqueta dentro da lista de tags da Sidebar — usado quando o usuário já tem etiquetas criadas e precisa navegar/filtrar por elas no painel lateral.
...
ponto-fixo)** — `get_design_context` refeito do zero no node `1421:20907`,

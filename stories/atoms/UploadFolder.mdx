...
Sem descrição de uso própria no Figma (só nome + geometria) — glifo
composto de 2 vetores sobrepostos: contorno de pasta (`Vector`,
`1421:17836`) + seta de upload pequena (`Vector`, `1421:17837`),
16×16px, `overflow-clip`. Nenhum eixo de variante/estado confirmado (um
único vetor estático).

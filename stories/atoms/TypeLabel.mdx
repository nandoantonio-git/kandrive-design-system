...
Badge de **tipo de arquivo** (Documento/Imagem/Vídeo, com ponto de cor por tipo) — usado em listas e nos estados expandidos de dropdown de etiqueta (`molecule/Label`) pra filtrar/indicar categoria de conteúdo.

...
> ✅ **Reconciliado com o Figma em 2026-08-09.** Os 15 tokens de tipo abaixo
> foram lidos diretamente da seção "Typography" (`get_variable_defs`, nó
...
> 🔧 **Correção de acessibilidade em 2026-08-10 (US-011).** A Regra 4 foi
...
> abaixo até do piso de exceção) para 11px. Ver seção "Política de exceção
> de 16px (Regra 4)" abaixo.

## Família

✅ **Figma-confirmado**: todos os 15 tokens usam `Figtree`, confirmando a
...
é trabalho de implementação, fora do escopo desta US, que é somente-doc.)

## Escala tipográfica (Figma-confirmado)

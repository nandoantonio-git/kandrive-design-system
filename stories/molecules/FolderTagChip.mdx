...
**Status: 🔧 corrigido em auditoria Regra 11 (US-026)** · **⚠️ gap aberto —
...
**Achado da auditoria Regra 11 (2026-08-11):** `get_design_context` não
...
**Achado novo, não corrigido (ambíguo):** no estado `Default`

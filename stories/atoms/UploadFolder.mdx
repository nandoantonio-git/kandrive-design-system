...
Glifo composto (pasta + seta de upload) — ícone de upload de uma pasta (descrição do Figma, adicionada pelo usuário em 2026-08-14). Use em qualquer ação de upload que seja especificamente de uma pasta inteira, não de um arquivo avulso.
...
**Descrição adicionada pelo usuário em 2026-08-14** — `get_design_context`
fresco no mesmo node (`1439:17053`) retorna agora uma descrição de uso que
antes não existia: verbatim *"icone de upload de uma pasta"*.

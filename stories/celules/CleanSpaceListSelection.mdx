...
fluxo — não é um item de lista genérico, composto direto em
...
fresco no nó `1436:20496` re-confirma o ícone de arquivo azul (`#2b7fff`,
...
[`organism/cleanSpaceStorage`](../organisms/CleanSpaceStorage.mdx) (US-010)

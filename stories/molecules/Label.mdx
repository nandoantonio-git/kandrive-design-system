...
Pílula de dropdown de etiquetas — descrição verbatim: *"pilula de dropdown
de etiquetas"*. Use nos fluxos gerais de etiquetagem de arquivo; dentro do
canvas de organização, o equivalente é `DropdownSelectLabel`.
...
## ⚠️ Achado: possível duplicidade no Figma fonte (Regra 9)

...
import { SaveLongTermFileStorageSelectedFiles } from "@/components/organisms/save-long-term-file-storage-selected-files"
...
/**
 * template/Save/LongTermFileStorage (`1439:16907`) — sem descrição própria
 ...
 * `template/Save/LongTermFileStorage`, mesmo nodeId `1439:16907`) — ver
 * `docs/vault/Design System/Camadas Atômicas.md`. A coluna esquerda de
 * seleção ganhou symbol Figma próprio
 * (`organism/Save/LongTermFileStorage/SelectedFiles`, `1555:21357`) —
 * extraída para `SaveLongTermFileStorageSelectedFiles` (Regra 10).
 */
